...
// $Id: calendar.js,v 1.1 2004/12/17 13:13:21 dcbo Exp $
...
Calendar = function (mondayFirst, dateStr, onSelected, onClose) {
	...
	this.titleDateFormat = Calendar._TT["TITLE"];
	this.isPopup = true;
...
Calendar.dayMouseOver = function(ev) {
	...
	if (el.ttip) {
		if (el.ttip.substr(0, 1) == "_") {
			...
			el.ttip = el.calendar.titleDateFormat + date.print(el.calendar.ttDateFormat) + el.ttip.substr(1);
		}
		...
		for (var j = 0; j < 7; ++j) {
			...
			if (!cell.disabled) {
				...
				if (hasToday && (iday == todayDate)) {
					...
					cell.ttip += Calendar._TT["PART_NOT_TODAY"];
				}
